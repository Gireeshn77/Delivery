...
public class ExtentReportsListeners implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkreporter = new ExtentSparkReporter("C:\\Selenium projects\\Delivery\\Reports\\MyReport.html");
		
	//	sparkreporter = new ExtentSparkReporter("C:\\Selenium projects\\Delivery\\Reports\\" + Repname);
	...
	public void onTestFailure(ITestResult result) {
		...
		// String screenshotpath="C:\\Selenium
		// projects\\Delivery\\Screenshots"+tname+".png"; // not saving in this path
		// currently so given other path
